...
var createRouterHandleableBuilderFromRouteBuildSpecs = function(routeBuildSpecs) {
  var handleableBuilder = function(config, callback) {
    createRouterHandleableFromRouteBuildSpecs(config, routeBuildSpecs, callback)
  }
...
module.exports = {
  ...
  createRouterHandleableBuilderFromRouteBuildSpecs: createRouterHandleableBuilderFromRouteBuildSpecs,
